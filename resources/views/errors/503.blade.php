...
<div class="container-xxl container-p-y">
  <div class="misc-wrapper">
    ...
    <p class="mb-6 mx-2">{{ __('The service is temporarily unavailable. Please try again later.') }}</p>
    <a href="{{url('/')}}" class="btn btn-primary mb-10">{{ __('Back to home') }}</a>
    <div class="mt-4">
      <img src="{{ asset('assets/img/illustrations/service-unavailable.svg') }}" alt="service-unavailable" class="img-fluid" style="max-width: 225px; width: 100%; height: auto;">
    </div>
  </div>
</div>
