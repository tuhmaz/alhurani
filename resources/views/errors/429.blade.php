...
<div class="container-xxl container-p-y">
  <div class="misc-wrapper">
    <h1 class="mb-2 mx-2 fs-xxlarge" style="line-height: 6rem; font-size: 6rem;">429</h1>
    <h4 class="mb-2 mx-2">{{ __('Too Many Requests') }} ⚠️</h4>
    <p class="mb-6 mx-2">{{ __('You have sent too many requests. Please wait a moment and try again.') }}</p>
    <a href="{{url('/')}}" class="btn btn-primary mb-10">{{ __('Back to home') }}</a>
    <div class="mt-4">
      <img src="{{ asset('assets/img/illustrations/page-misc-error.svg') }}" alt="page-misc-error" class="img-fluid" style="max-width: 225px; width: 100%; height: auto;">
    </div>
  </div>
</div>
